...
"""
    ...
    if status_data["depression_score"] >= 7 and status_data["sentiment_score"] >= 0.8:
        status_data["type"] = "high"
    elif ((5.5 <= status_data["depression_score"] <= 7) and (0.6 <= status_data["sentiment_score"] < 0.8)) or (status_data["disease"] not in [None, "", []]):
